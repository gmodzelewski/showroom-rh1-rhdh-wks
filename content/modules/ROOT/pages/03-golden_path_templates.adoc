...
NOTE: You can also access the Documentation form by selecting Docs from the upper menu.
...
* Click on the *Scan Results* for the image tagged as *latest* to review its scan results.
